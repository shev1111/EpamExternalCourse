...
public class PlayingRoom <E> {
    ...
    public int getGeneralToysPrice(){
        int sum =0;
        for (Object elem : box) {
            if(elem instanceof task3.task31.model.entity.AbstractToy){
                sum = sum+((task3.task31.model.entity.AbstractToy) elem).getPrice();
            }
    ...
    public E[] getToysBeforePrice(E[] list,int price){
        for (Object elem : box) {
            if(elem instanceof task3.task31.model.entity.AbstractToy){
                task3.task31.model.entity.AbstractToy toy = (task3.task31.model.entity.AbstractToy) elem;
    ...
    public E[] getToysBeforeAge(E[] list, int age){
        for (Object elem : box) {
            if(elem instanceof task3.task31.model.entity.AbstractToy){
                task3.task31.model.entity.AbstractToy toy = (AbstractToy) elem;
                if(toy.getAge()<=age){
                    list[selectionSize++]= (E) toy;
                }
            }
